...
const I18N = {
  en: {
    ...
    ig_outfits_p: "You don&rsquo;t need to buy traditional wear &mdash; renting is easy and popular. Jaipur and Delhi have many shops and online services renting sarees, lehengas, sherwanis and kurtas, often with delivery to your hotel and help with draping. If you&rsquo;d like to buy, Jaipur is famous for block-printed and bandhani fabrics.",
    ...
    ig_outfits_note: "Direct booking links will be confirmed closer to the date &mdash; ask us if you&rsquo;d like a personal recommendation.",
    ...
    hero_kicker: "With love, we invite you to celebrate",
    ...
    cel_sub: "2.5 days of festivities. Many of the events are traditional Indian ceremonies &mdash; we&rsquo;ve added a short note on each so everyone can follow along. Timings are indicative and may shift slightly.",
    ...
    air_h: "By Air",
    air_p: "From Paris, we&rsquo;d recommend Emirates via Dubai to Jaipur (JAI), around 13 hours in total including the layover. Air France from CDG to Jaipur is another option, usually with a layover (often via Amsterdam and Delhi), roughly 15&ndash;20 hours all in. You can also fly Paris to Delhi direct and take a taxi the rest of the way: about 300&nbsp;km, roughly a 4&ndash;5 hour drive.",
    train_h: "By Train",
    ...
    faq_q4: "What food will be served?", faq_a4: "It&rsquo;s a fully vegan wedding &mdash; all food and drink is plant-based, with plenty of options throughout. If you have any specific dietary requirements, please contact us in advance so we can make arrangements.",
  ...
  hi: {
    ...
    air_h: "हवाई मार्ग से",
    air_p: "पेरिस से, हम एमिरेट्स द्वारा दुबई होते हुए जयपुर (JAI) की सलाह देते हैं, लेओवर सहित कुल लगभग 13 घंटे। एक और विकल्प एयर फ़्रांस से CDG से जयपुर है, आमतौर पर एक लेओवर के साथ (अक्सर एम्स्टर्डम और दिल्ली होते हुए), कुल मिलाकर लगभग 15&ndash;20 घंटे। आप पेरिस से दिल्ली सीधी उड़ान लेकर बाकी रास्ता टैक्सी से भी तय कर सकते हैं: लगभग 300&nbsp;किमी, करीब 4&ndash;5 घंटे की ड्राइव।",
    ...
    faq_q4: "कैसा भोजन परोसा जाएगा?", faq_a4: "यह पूरी तरह वीगन विवाह है &mdash; सारा भोजन और पेय पूर्णतः पादप-आधारित है, और पूरे आयोजन में भरपूर विकल्प उपलब्ध रहेंगे। अगर आपकी कोई विशेष आहार संबंधी ज़रूरत हो, तो कृपया पहले से हमसे संपर्क करें ताकि हम व्यवस्था कर सकें।",
  ...
  fr: {
    ...
    ig_outfits_note: "Les liens de réservation directs seront confirmés à l&rsquo;approche de la date &mdash; demandez-nous si vous souhaitez une recommandation personnalisée.",
    ...
    hero_kicker: "Avec tout notre amour, nous vous invitons à célébrer",
    ...
    cel_sub: "2,5 jours de festivités. La plupart des événements sont des cérémonies indiennes traditionnelles &mdash; une courte note accompagne chacune pour que tout le monde puisse suivre. Les horaires sont indicatifs et peuvent légèrement changer.",
    ...
    travel_title: "Accès",
    air_h: "En avion",
    air_p: "Depuis Paris, nous recommandons Emirates via Dubaï jusqu&rsquo;à Jaipur (JAI), environ 13 heures au total avec l&rsquo;escale. Autre option : Air France depuis CDG vers Jaipur, généralement avec une escale (souvent via Amsterdam et Delhi), soit environ 15&ndash;20 heures en tout. Vous pouvez aussi prendre un vol Paris&ndash;Delhi direct puis un taxi pour la suite : environ 300&nbsp;km, soit 4&ndash;5 heures de route.",
    train_h: "En train",
    ...
    faq_q4: "Quelle nourriture sera servie ?", faq_a4: "C&rsquo;est un mariage entièrement vegan &mdash; toute la nourriture et les boissons sont d&rsquo;origine végétale, avec de nombreuses options tout au long. Si vous avez des besoins alimentaires particuliers, merci de nous contacter à l&rsquo;avance afin que nous puissions nous organiser.",
