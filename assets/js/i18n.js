...
const I18N = {
  en: {
    ...
    dress_lead: "All suggestions, never rules. Dress traditionally if you&rsquo;d like &mdash; or don&rsquo;t. These are just inspiration palettes to have fun with.",
    dc1_event: "The Henna Ceremony",
    dc1_pal: "Shades of green &mdash; sage, olive, emerald, forest, mint.",
    dc1_vibe: "Moroccan, brass touches &mdash; a warm, intimate evening.",
    dc1_note: "Wear whatever makes you feel festive &mdash; greens are especially welcome!",
    dc2_event: "The Turmeric Ceremony",
    dc2_pal: "Yellow if you can &mdash; mustard, lemon, gold, saffron.",
    dc2_vibe: "Rajasthani &mdash; think marigolds, warmth and colour.",
    dc2_note: "White also works beautifully for Haldi &mdash; turmeric will find you regardless!",
  ...
  hi: {
    ...
    dress_lead: "ये सिर्फ़ सुझाव हैं, नियम नहीं। पारंपरिक परिधान पहनना चाहें तो ज़रूर पहनें &mdash; या न पहनें। ये बस प्रेरणा के लिए रंग-संयोजन हैं।",
    dc1_event: "मेहंदी समारोह",
    dc1_pal: "हरे रंग के शेड्स &mdash; सेज, ऑलिव, एमराल्ड, फ़ॉरेस्ट, मिंट।",
    dc1_vibe: "मोरक्कन अंदाज़, पीतल की झलक &mdash; एक गर्मजोशी भरी, आत्मीय शाम।",
    dc1_note: "जो पहनकर आपको उत्सव जैसा लगे वही पहनें &mdash; हरे रंग का विशेष स्वागत है!",
    dc2_event: "हल्दी समारोह",
    dc2_pal: "हो सके तो पीला &mdash; सरसों, नींबू, सुनहरा, केसरिया।",
    dc2_vibe: "राजस्थानी अंदाज़ &mdash; गेंदे के फूल, गर्माहट और रंग।",
    dc2_note: "हल्दी के लिए सफ़ेद भी बहुत सुंदर लगता है &mdash; हल्दी तो आप तक पहुँच ही जाएगी!",
  ...
  fr: {
    ...
    dress_lead: "Des suggestions, jamais des règles. Portez une tenue traditionnelle si vous le souhaitez &mdash; ou non. Ce ne sont que des palettes d&rsquo;inspiration pour s&rsquo;amuser.",
    dc1_event: "La cérémonie du henné",
    dc1_pal: "Nuances de vert &mdash; sauge, olive, émeraude, forêt, menthe.",
    dc1_vibe: "Esprit marocain, touches de laiton &mdash; une soirée chaleureuse et intime.",
    dc1_note: "Portez ce qui vous met dans l&rsquo;ambiance &mdash; le vert est particulièrement bienvenu !",
    dc2_event: "La cérémonie du curcuma",
    dc2_pal: "Du jaune si possible &mdash; moutarde, citron, or, safran.",
    dc2_vibe: "Esprit rajasthani &mdash; soucis, chaleur et couleur.",
    dc2_note: "Le blanc fonctionne aussi très bien pour le Haldi &mdash; le curcuma vous trouvera de toute façon !",
